...
function OpenCloakroomMenu()
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      if data.current.value == 'barman_outfit' or
...
AddEventHandler('esx_nightclub:hasEnteredMarker', function(zone)
   ...
   if zone == 'BossActions' and IsGradeBoss() then
    ...
    if zone == 'Flacons' or zone == 'NoAlcool' or zone == 'Apero' or zone == 'Ice' or zone == 'Flacons2' then
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlJustReleased(0,  Keys['E']) and IsJobTrue() then
        ...
        if CurrentAction == 'menu_shop' then
            OpenItemMenu(CurrentActionData.zone)
        end
...
positions = {
    --[[
    {{Teleport1 X, Teleport1 Y, Teleport1 Z, Teleport1 Heading}, {Teleport2 X, Teleport 2Y, Teleport 2Z, Teleport2 Heading}, {Red, Green, Blue}, {"Text for Teleport"}, "Text for Unemployed}
    ]]
    {{138.05, -3204.1, 4.85, 270.5}, {-1637.78, -2989.99, -78.59, 273.0}, {255,255,255}, "Sie sind kein Angestellter des ~p~Nachtclubs"}, 
...
Citizen.CreateThread(function ()
    while true do
        ...
        for _,location in ipairs(positions) do
            teleport_text = location[5]
            no_employe = location[4]
            loc1 = {
                x=location[1][1],
                y=location[1][2],
                z=location[1][3],
            ...
            if CheckPos(playerLoc.x, playerLoc.y, playerLoc.z, loc1.x, loc1.y, loc1.z, 2) and IsJobTrue() then 
                alert (_U('e_enter'))
            ...
            elseif CheckPos(playerLoc.x, playerLoc.y, playerLoc.z, loc2.x, loc2.y, loc2.z, 2) and IsJobTrue() then
                alert (_U('e_leave'))
...
positions2 = {
    ...
    {{-1516.47, -2978.49, -81.85, 270.5}, {-1639.85, -3013.05, -79.14, 0.51}, {255,255,255}, "Sie sind kein Angestellter des ~p~Nachtclubs"}, 
...
Citizen.CreateThread(function ()
    while true do
        ...
        for _,location in ipairs(positions2) do
            teleport_text = location[5]
            no_employe = location[4]
            loc1 = {
                x=location[1][1],
